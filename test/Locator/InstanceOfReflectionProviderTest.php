...
#[CoversClass(InstanceOfReflectionProvider::class)]
final class InstanceOfReflectionProviderTest extends TestCase
{
    ...
    public function testGetReflectionNonPhpFileReturnsNull(): void
    {
        ...
        $provider = new InstanceOfReflectionProvider($this->loader, FormInterface::class);
    ...
    public function testGetReflectionNotInstanceOfReturnsNull(): void
    {
        ...
        $provider = new InstanceOfReflectionProvider($this->loader, FieldsetInterface::class, FormInterface::class);
    ...
    public function testGetReflectionFromPathReturnsReflection(): void
    {
        ...
        $path     = __DIR__ . '/Asset/TestForm.php';
        $provider = new InstanceOfReflectionProvider($this->loader, FieldsetInterface::class);

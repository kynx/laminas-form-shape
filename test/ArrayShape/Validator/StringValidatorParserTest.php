...
final class StringValidatorParserTest extends TestCase
{
    ...
    {
        $parser = new StringValidatorParser();
        $actual = $parser->getTypes($validator, [PsalmType::String, PsalmType::Null]);
    ...
    {
        $parser = new StringValidatorParser();
        $actual = $parser->getTypes(new Barcode(), [PsalmType::Bool]);
    ...
    public function testGetTypesUsesConstructorValidators(): void
    {
        ...
        $parser   = new StringValidatorParser([Uuid::class]);
        $actual   = $parser->getTypes(new Barcode(), $expected);

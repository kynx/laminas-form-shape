...
final readonly class FileWriter implements FileWriterInterface
{
    ...
    public function write(
        ...
        try {
            ...
            throw WriterException::fileRead($reflection, $throwable);
        }
        ...
        if ($class === null || $namespace === null) {
            throw WriterException::classNotFound($reflection);
        }
        ...
        file_put_contents($reflection->getFileName(), (new PsrPrinter())->printFile($file));
